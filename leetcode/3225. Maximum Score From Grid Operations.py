...
grid_1 = [[0, 0, 0, 0, 0], [0, 0, 3, 0, 0], [0, 1, 0, 0, 0], [5, 0, 0, 3, 0],
          [0, 0, 0, 0, 2]]
grid_2 = [[10, 9, 0, 0, 15], [7, 1, 0, 8, 0], [5, 20, 0, 11, 0],
          [0, 0, 0, 1, 2], [8, 12, 1, 10, 3]]
grid_3 = [[5, 3], [2, 4]]
solution = Solution()

assert solution.maximumScore(grid_1) == 11
assert solution.maximumScore(grid_2) == 94
